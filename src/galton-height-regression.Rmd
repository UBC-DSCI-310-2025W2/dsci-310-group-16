...
We found that midparent height (i.e., weighted average between father's height (weight = 1) and mother's height (weight = 1.08)) had a positive relationship with their children's height. Gender also was a strong predictor of height, as male children were predicted to be approximately 5.21 inches taller than their female equivalents. Both variables were very statistically significant, with p-values less than 0.01.
