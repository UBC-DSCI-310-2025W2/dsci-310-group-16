...
```{r fig.cap="Figure 5. Relationship Between Midparent Height and Child Height by Gender."}
# Scatterplot with regression line
ggplot(galton_train, aes(x = midparent_height, y = child_height, color = gender)) +
