...
- questions or concerns pertaining to project parts
- issues and flags that team members should be aware of
- schedule conflicts or upcoming commitments

Messages should be responded to within 24 hours, preferably as soon as possible. Extentuating life circumstances should be communicated within reasonable time 

**Acknowledgement and Attribution** - We expect all work to be properly attributed and credited when appropriate. All external sources should be properly cited, with direct quotes explicitly declared. 

**Quality and Timeliness of Work** - We expect all parts do be completed with care and high degree of quality. This includes taking the reasonable effort to ensure accuracy of work, minimize errors in the work, and adhere to given guidelines and deliverable guidelines. Feedback and constructive criticism should be promptly considered and incorporated when reasonable. 
