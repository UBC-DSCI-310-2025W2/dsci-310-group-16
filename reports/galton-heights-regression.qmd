...
![Relationship between mother’s height and father’s height in the dataset."](../results/eda/eda_...){#fig-... width="50%"}

[figure 4 is currently missing. this is a placeholder for it]{style="color:red;"}
...
`r paste0("$\\text{Child Height} = ", 
          intercept, " + ", 
          midparent_height, " (\\text{Midparent Height}) + ",
          gendermale, " (\\text{Male})$")`
